...
class Item(models.Model):
    ...
    height_m = models.DecimalField(max_digits=5, decimal_places=0, blank=True, null=True)
    weight_kg = models.DecimalField(max_digits=5, decimal_places=0, blank=True, null=True)
    ...
    def __str__(self):
        return (
            ...
            f"{self.permanent_house_no} {self.permanent_street} {self.permanent_brgy} {self.permanent_city} {self.permanent_province} {self.permanent_zipcode} "
            ...
            f"{self.elementary_school} {self.junior_high_school} {self.senior_high_school} {self.college}"
        )